...
<html>
    ...
    <body>
        ...
        <main>
            <img src="img/aboutfoto.jpg" class="home-foto" alt="">

            <div class="aboutcontainer">
                <h3 class="abouttitulli">About Us</h3>
                <p class="aboutp">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ad magni blanditiis facere, tempora dignissimos.</p>
                ...
                <p class="aboutp">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam sapiente non maxime rem repellat ipsum dolorem ad exercitationem nam, est facilis. Cumque, totam!</p>
            </div>

            <div class="pije-container" >
                <img src="img/aboutfullfoto.jpg" alt="" class="pije-foto">
            </div>
